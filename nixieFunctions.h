...
#define DEFALUT_REFRESH_RATE    0x02//0xD8    //refresh of the lamps, counter value
#define DEFAULT_PWM_FREQUENCY   0x03//0x80    //counter value to establish pwm frequency
#define DEFAULT_PWM_DUTYCYCLE   0x04//0x45    //counter value to set duty cycle
#define DEFAULT_SOURCE_CLASS    0x05
#define DEFAULT_SOURCE_ID       0x06
...
#define START_DETOX_KATHODE_PROCEDURE   0x01
#define NO_DETOX_KATHODE_PROCEDURE   0x00

#define NIXIE_OFF   0x00
#define NIXIE_ON    0x01
...
uint8_t newDetox;
uint8_t sourcedevice_ID;
uint8_t sourcedevice_CLASS;
...
//fucntion performs detox procedure to heal cathodes of lamps
